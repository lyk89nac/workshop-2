...
let updateBudtetButton = document.querySelector('#update_budget');
...
// console.log(updateBudtetButton);
// events
updateBudtetButton.onclick = updateBudget;
...
function updateExpenseTotal() {
    ...
    for (let i = 0; i < expenses.length; i++) {
        ...
        // expenses - is an "array"  [1, 2, 3];
        // when we want the value of hte first element = 
        // expenses[0] = 1;
        // expenses[1] = 2;
        // expenses[2] = 3;
        // expenses[i] = ???
